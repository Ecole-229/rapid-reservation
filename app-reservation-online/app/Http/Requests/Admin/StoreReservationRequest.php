...
class StoreReservationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'telephone' => ['required_without:user_id', 'nullable', 'string', 'max:50'],
    ...
    public function messages(): array
    {
        return [
            ...
            'telephone.required_without' => 'Le numéro de téléphone du client est obligatoire si aucun compte utilisateur n\'est sélectionné.',
